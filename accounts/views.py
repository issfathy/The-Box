...
from .forms import UserRegistrationForm, UserProfileForm, LoginForm, EditProfileForm, DeleteProfileForm
...
def delete_event(request, username):
	...
	delete_form = DeleteProfileForm(request.POST, request.FILES, instance=request.user)
	user = request.user
	user.delete()
