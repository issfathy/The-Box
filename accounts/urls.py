...
urlpatterns = [
    ...
    # url to block a profile
	path('<str:username>/mute', views.mute_view, name='mute_view'),

    path('inbox/', views.ListThreads.as_view(), name="inbox"),
    # url to create thread
    path('inbox/create-thread/',
         views.CreateThread.as_view(), name="create-thread"),
    # url to thread
    path('inbox/<int:pk>/',
    ...
    # url to delete profile
    path('<str:username>/delete_account',
